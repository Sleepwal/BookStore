...
<head>
    ...
    <script src="${pageContext.request.contextPath}/WEB-INF/lib/jquery-3.6.0.min.js"></script>
...
<form id="form" action="${pageContext.request.contextPath}/Register" method="post">
    ...
    <table align="center">
        ...
        <tr>
            ...
            <td align="center"><input id="submit" type="image" src="${pageContext.request.contextPath}/client/images/signup.gif" alt="Submit"/></td>
        </tr>
        <tr>
            <td></td>
