            ...
            <td align="center" bgColor="#f5fafe">
                <table cellspacing="0" cellpadding="1" rules="all"
                    ...
                    <tr
                        ...
                        <td align="center" width="5%">公告编号</td>
                        <td align="center" width="15%">公告标题</td>
                        <td align="center" width="24%">公告内容</td>
                        <td align="center" width="14%">时间</td>
                        <td width="8%" align="center">编辑</td>
                        <td width="8%" align="center">删除</td>
                    </tr>
                    <!--  循环输出所有商品 -->

                    <c:forEach items="${ns}" var="notice">
                        ...
                        <tr onmouseover="this.style.backgroundColor = 'white'"
                            ...
                            <td align="center" style="HEIGHT: 22px" width="7%">
                                <a href="${pageContext.request.contextPath}/FindNoticeById?id=${notice.n_id}">
                                    <input type="button" style="color: #2fd529; font-weight: bold" value="✎"/>
                                </a>
                            </td>
                            <!-- 删除 -->
                            <td align="center" style="HEIGHT: 22px" width="7%">
                                <a href="${pageContext.request.contextPath}/DeleteNotice?id=${notice.n_id}">
